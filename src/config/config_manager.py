...
class ConfigManager:
    ...
    def __init__(self, config_file: str = "config.json"):
        self.logger = get_logger("ConfigManager", ui_queue=log_queue)
    ...
    def get_card_replacement_strategy(self) -> str:
        """获取换牌策略，默认返回 'full_replacement'"""
        # 从配置中获取策略，如果不存在则使用默认值
        return self.get("card_replacement.strategy", "full_replacement")
